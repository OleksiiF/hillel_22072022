...
# set_inside = {1, True, different_types, None}  # will rise TypeError   !!!! -  dict, set, list
############################################################
# set_a = {1, 3, 5, 7, 9}
...
# print(f"set_a & set_b --> {set_a & set_b & set_c}")
############################################################
...
# print(f"set_a ^ set_b --> {set_a ^ set_b ^ set_c ^ set_d}")
############################################################
# my_set = {1, 2, 3, 4, 5, 6}
# print(f"{my_set=}")
# my_set.add('sdf')
...
#
# usual_set.add(1)
# frozen_set.add(1)  # will rise AttributeErrorr
############################################################
# empty_dict = {}
# empty_dict = dict()
#
...
#     print("Huston, we have a problem here -->", error)
############################################################
# people = [
#     {
#         "name": "Alex",
...
#
# print(f"{one_more_dict.get('is rain')=}")  # one_more_dict['is rain']
